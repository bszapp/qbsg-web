...
const DocsIcon = svgIconRaw('<circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/>')
...
const GujianIcon = svgIconRaw('<circle cx="12" cy="5" r="3"/><circle cx="19" cy="19" r="3"/><circle cx="5" cy="19" r="3"/><line x1="12" y1="8" x2="12" y2="13"/><line x1="12" y1="13" x2="5" y2="19"/><line x1="12" y1="13" x2="19" y2="19"/>')
...
const Gujian = () => import('../views/Gujian.vue')
...
export const navItems = [
  ...
  { path: '/docs', name: 'docs', label: '教程', icon: OrdersIcon, component: Docs, requiresAuth: false },
  { path: '/gujian', name: 'gujian', label: '固件', icon: GujianIcon, component: Gujian, requiresAuth: false },
